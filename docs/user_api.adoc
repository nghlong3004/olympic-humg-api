...
Lấy thông tin user dựa trên token hiện tại.
...
Không cho phép cập nhật: `email`, `role`, `isActive`.

*Request*

[source,subs="attributes+"]
----
PATCH {api-base}user/me
----
...
[source,subs="attributes+"]
----
GET {api-base}user?keyword=long&page=0&size=10
----
