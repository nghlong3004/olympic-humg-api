...
* `TEACHER` / `ADMIN`: tạo, sửa, xoá câu hỏi
* `STUDENT`: chỉ xem câu hỏi khi làm bài/ôn tập (tùy business logic)
...
| `correctAnswer` | string           | Đáp án đúng (text). Với `MULTIPLE_CHOICE` thường là `"A"`, `"B"`,... hoặc `"A;C"`.
