...
----
GET {api-base}/assignment/5/question
----
...
| `active`| boolean | no      | Nếu `true` chỉ lấy câu hỏi `isActive = true`
|===
...
[source,subs="attributes+"]
----
GET {api-base}/assignment/5/question/101
----
...
[source,subs="attributes+"]
----
POST {api-base}/assignment/5/question
----
...
[source,subs="attributes+"]
----
PATCH {api-base}/assignment/5/question/101
----
...
[source,subs="attributes+"]
----
DELETE {api-base}/assignment/5/question/101
----
